...
Number::Phone::NANP::SX - SX-specific methods for Number::Phone

=head1 DESCRIPTION

This class implements SX-specific methods for Number::Phone.  It is
...
=head1 SYNOPSIS
    ...
    my $phone_number = Number::Phone->new('+1 721 555 0001');
    # returns a Number::Phone::NANP::SX object
